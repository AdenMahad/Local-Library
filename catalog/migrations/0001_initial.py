# Generated by Django 4.2.1 on 2023-05-24 15:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary', models.TextField(help_text='provide  description for this book ', max_length=1000)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='enter the language  of the book', max_length=100, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='BookInstance',
